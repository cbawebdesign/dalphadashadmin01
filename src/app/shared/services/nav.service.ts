...
export class NavService {
	...
	MENUITEMS: Menu[] = [
		{
			title: 'Dashboard', icon: 'folder-plus', type: 'sub', badgeType: 'primary', badgeValue: 'new', active: false, children: [
				...
				{ path: '/dashboard/limitedpartner01', title: 'limitedPartner01', type: 'link' },
				{ path: '/dashboard/limitedpartner02', title: 'limitedPartner02', type: 'link' },
				{ path: '/dashboard/limitedpartner03', title: 'limitedPartner03', type: 'link' },
				{ path: '/dashboard/limitedpartner04', title: 'limitedPartner04', type: 'link' },
				{ path: '/dashboard/limitedpartner05', title: 'limitedPartner05', type: 'link' },
				{ path: '/dashboard/limitedpartner06', title: 'limitedPartner06', type: 'link' },
				{ path: '/dashboard/limitedpartner07', title: 'limitedPartner07', type: 'link' },
				{ path: '/dashboard/limitedpartner08', title: 'limitedPartner08', type: 'link' },
				{ path: '/dashboard/limitedpartner09', title: 'limitedPartner09', type: 'link' },
				{ path: '/dashboard/limitedpartner10', title: 'limitedPartner10', type: 'link' },
				{ path: '/dashboard/limitedpartner11', title: 'limitedPartner11', type: 'link' },
				{ path: '/dashboard/limitedpartner12', title: 'limitedPartner12', type: 'link' },
				{ path: '/dashboard/limitedpartner13', title: 'limitedPartner13', type: 'link' },
				{ path: '/dashboard/limitedpartner14', title: 'limitedPartner14', type: 'link' },
				{ path: '/dashboard/limitedpartner15', title: 'limitedPartner15', type: 'link' },
				{ path: '/dashboard/limitedpartner16', title: 'limitedPartner16', type: 'link' },
				{ path: '/dashboard/limitedpartner17', title: 'limitedPartner17', type: 'link' },
				{ path: '/dashboard/limitedpartner18', title: 'limitedPartner18', type: 'link' },
				{ path: '/dashboard/limitedpartner19', title: 'limitedPartner19', type: 'link' },
				{ path: '/dashboard/limitedpartner20', title: 'limitedPartner20', type: 'link' },
				{ path: '/dashboard/limitedpartner21', title: 'limitedPartner21', type: 'link' },
				{ path: '/dashboard/limitedpartner22', title: 'limitedPartner22', type: 'link' },
				{ path: '/dashboard/limitedpartner23', title: 'limitedPartner23', type: 'link' },
				{ path: '/dashboard/limitedpartner24', title: 'limitedPartner24', type: 'link' },
				{ path: '/dashboard/limitedpartner25', title: 'limitedPartner25', type: 'link' },
				{ path: '/dashboard/LP01Q12020', title: 'limitedPartner25', type: 'link' },
				// { path: '/dashboard/LP01newsletter', title: 'newsletter', type: 'link' },
				// { path: '/dashboard/LP02newsletter', title: 'newsletter', type: 'link' },
				// { path: '/dashboard/LP03newsletter', title: 'newsletter', type: 'link' },
				// { path: '/dashboard/LP04newsletter', title: 'newsletter', type: 'link' },
				// { path: '/dashboard/LP05newsletter', title: 'newsletter', type: 'link' },
		...
		// 		{ path: '/advance/toastr', title: 'LP Document Upload', type: 'link' },
